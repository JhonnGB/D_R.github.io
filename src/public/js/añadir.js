document.addEventListener("DOMContentLoaded", function () {
  ...
  añadirEnlace.addEventListener("click", function (event) {
    ...
    // const productId = añadirEnlace.getElementById();
    const productId = event.currentTarget.id;
    const cantidad = cantidadInput.value; // Obtiene la cantidad seleccionada
    ...
    fetch(`/agregar-producto/${productId}`, {
      ...
      body: JSON.stringify({ productId, cantidad, adicionales }), // Envia el ID del producto y la cantidad
    })
